...
namespace Taxi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260727081203_AddCustomerScheduledTripReminders")]
    partial class AddCustomerScheduledTripReminders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Taxi.Domain.Trips.Trip", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CustomerReminder15SentAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("CustomerReminder30SentAtUtc")
                        .HasColumnType("timestamp with time zone");
