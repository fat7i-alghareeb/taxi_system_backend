...
namespace Taxi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260508220009_AddTripPickupDetails")]
    partial class AddTripPickupDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taxi.Domain.Auth.OtpSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Taxi.Domain.Trips.Trip", b =>
                {
                    ...
                    b.Property<string>("PickupHouseNumber")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("PickupStreetName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("Taxi.Domain.Trips.Trip", b =>
                {
                    ...
                    b.OwnsOne("Taxi.Domain.Trips.Coordinate", "PickupCoordinate", b1 =>
                        {
